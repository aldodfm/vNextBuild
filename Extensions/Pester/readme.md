...
- Either
    ...
    - A script block to pass as a parameter. Defaults to @{Path='$(Build.SourcesDirectory)'; Parameters=@{param1=\"111\"; param2=\"222\"}}
...
- 6.1.x - Internal engineering no functional change
- 6.2.x - Issue265 Added option to use a script parameter as opposed to just a scriptpath
